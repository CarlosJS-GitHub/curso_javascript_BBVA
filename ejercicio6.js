...
2. En primer lugar (y en una sola instrucción) se debe comprobar si el número es menor que 0o mayor 
...
se muestra un mensaje al usuario diciéndole que la letra que ha indicado no es correcta. 
En otro caso, se muestra un mensaje indicando que el número y la letra de DNI son correctos.
*/

var letras = ['T', 'R', 'W', 'A', 'G', 'M', 'Y', 'F', 'P', 'D', 'X', 'B', 'N', 'J', 'Z', 'S', 'Q', 'V', 'H', 'L', 'C', 'K', 'E', 'T'];
var dni_num=53039744;
var dni_letra='L';

console.log(dni_num<0 || dni_num>99999999 ? 
    'número proporcionado no es válido': (letras[dni_num%23]==dni_letra ? 'correcto': 'no correcto'));
